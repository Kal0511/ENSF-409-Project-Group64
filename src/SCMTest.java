...
public class SCMTest {
    ...
    public void testPullData() throws SQLException {
        ...
        // add items
        inventory.addChair("C0010", "Test5", "Y", "N", "N", "N",
                10, "005");
        inventory.addChair("C0011", "Test5", "N", "Y", "N", "N",
                10, "005");
        inventory.addChair("C0012", "Test5", "N", "N", "Y", "N",
                10, "005");
        inventory.addChair("C0013", "Test5", "N", "N", "N", "Y",
                10, "005");
    ...
    public void testUpdateDatabase() throws SQLException {
        ...
        // add item
        inventory.addChair("C0009", "Test4", "Y", "Y", "Y", "Y",
                50, "005");
        ...
        assertTrue("Item has not been removed from database",
                !inventory.itemExists("C0009", "chair"));
    }
    ...
    public void testEvaluateRequest1() throws SQLException {
        ...
        inventory.addChair("C0000", "Test1", "Y", "Y", "Y", "N",
                20, "005");
        inventory.addChair("C0001", "Test1", "N", "Y", "Y", "Y",
                20, "005");
        inventory.addChair("C0002", "Test1", "Y", "N", "N", "Y",
                20, "005");
    ...
    public void testEvaluateRequest2() throws SQLException {
        ...
        inventory.addChair("C0003", "Test2", "Y", "Y", "Y", "N",
                500, "005");
        inventory.addChair("C0004", "Test2", "N", "N", "N", "Y",
                500, "005");
        inventory.addChair("C0005", "Test2", "Y", "N", "N", "N",
                50, "005");
        inventory.addChair("C0006", "Test2", "N", "Y", "Y", "Y",
                50, "005");
    ...
    public void testEvaluateRequest3() throws SQLException {
        ...
        inventory.addChair("C0007", "Test3", "N", "Y", "Y", "Y",
                50, "005");
