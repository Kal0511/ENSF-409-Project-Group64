...
/**
 * SCM is a program which takes a user request as input from the terminal window and searches mysql
 * database for requested items, it outputs a order form .txt file if the order can be filled, otherwise
 * outputs suggested manufacturers for the requested item.
 */
public class SCM {
